module RefreshSync
  ...
  module Capture
    ...
    def _refresh_sync_capture
      ...
      return _refresh_sync_refuse(recording) if recording.incomplete?
      _refresh_sync_register(recording)
    end
    ...
    def _refresh_sync_refuse(recording)
    ...
    def _refresh_sync_register(recording)
      ...
      cohort = _refresh_sync_register_cohort(recording, viewer)
      ...
      surface_streams = _refresh_sync_stamp_generations(recording, viewer)
    ...
    def _refresh_sync_register_cohort(recording, viewer)
      RefreshSync.store.register(
    ...
    def _refresh_sync_stamp_generations(recording, viewer)
      generations = []
      surface_streams = []
