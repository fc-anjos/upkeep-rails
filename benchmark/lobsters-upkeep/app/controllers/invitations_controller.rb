class InvitationsController < ApplicationController
  ...
  def create
    ...
    return redirect_to "/" if params[:return_home]
  ...
  def create_by_request
    return redirect_to "/login" unless Rails.application.allow_invitation_requests?
      @invitation_request = InvitationRequest.new(
  ...
  def delete_request
    return redirect_to "/invitations" if !@user.can_see_invitation_requests?
