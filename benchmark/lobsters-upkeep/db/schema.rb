...
ActiveRecord::Schema[7.0].define(version: 2026_05_14_082331) do
  ...
  create_table "comments", id: :bigint, force: :cascade do |t|
    t.datetime "created_at", precision: nil, null: false
  ...
  create_table "hat_requests", id: :bigint, force: :cascade do |t|
  ...
  create_table "hats", id: :bigint, force: :cascade do |t|
    t.datetime "created_at", precision: nil
    t.datetime "updated_at", precision: nil
    t.bigint "user_id", null: false
  ...
  create_table "hidden_stories", id: :bigint, force: :cascade do |t|
    t.bigint "user_id", null: false
    t.bigint "story_id", null: false
  ...
  create_table "invitation_requests", id: :bigint, force: :cascade do |t|
    t.string "code"
  ...
  create_table "invitations", id: :bigint, force: :cascade do |t|
    t.bigint "user_id", null: false
    t.string "email"
    t.string "code"
    t.datetime "created_at", precision: nil, null: false
  ...
  create_table "keystores", id: :bigint, force: :cascade do |t|
    t.string "key", limit: 50, default: "", null: false
    t.bigint "value"
    t.index [ "key" ], name: "key", unique: true
  end

  create_table "messages", id: :bigint, force: :cascade do |t|
    t.datetime "created_at", precision: nil
  ...
  create_table "mod_notes", id: :bigint, force: :cascade do |t|
  ...
  create_table "moderations", id: :bigint, force: :cascade do |t|
    t.datetime "created_at", precision: nil, null: false
    t.datetime "updated_at", precision: nil, null: false
  ...
  create_table "read_ribbons", id: :bigint, force: :cascade do |t|
  ...
  create_table "saved_stories", id: :bigint, force: :cascade do |t|
    t.datetime "created_at", precision: nil, null: false
    t.datetime "updated_at", precision: nil, null: false
    t.bigint "user_id", null: false
    t.bigint "story_id", null: false
  ...
  create_table "stories", id: :bigint, force: :cascade do |t|
    t.datetime "created_at", precision: nil
    t.bigint "user_id", null: false
  ...
  create_table "suggested_taggings", id: :bigint, force: :cascade do |t|
    t.bigint "story_id", null: false
  ...
  create_table "suggested_titles", id: :bigint, force: :cascade do |t|
    t.bigint "story_id", null: false
    t.bigint "user_id", null: false
    t.string "title", limit: 150, default: "", null: false
  ...
  create_table "tag_filters", id: :bigint, force: :cascade do |t|
    t.datetime "created_at", precision: nil, null: false
    t.datetime "updated_at", precision: nil, null: false
    t.bigint "user_id", null: false
    t.bigint "tag_id", null: false
  ...
  create_table "taggings", id: :bigint, force: :cascade do |t|
    t.bigint "story_id", null: false
    t.bigint "tag_id", null: false
  ...
  create_table "votes", id: :bigint, force: :cascade do |t|
    t.bigint "user_id", null: false
    t.bigint "story_id", null: false
    t.bigint "comment_id"
